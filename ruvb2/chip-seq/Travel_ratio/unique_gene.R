...
# gene share the same TSS and TTS; if the script share the same TSS, I will choose the longer
# gene and remove the shorter gene;
output_dir <- './'
command=matrix(c(
