...
#--- 4. 转bigwig 和 call peak
mkdir -p ${outputdir}/unique
/home/boyuanli/bashscript/bin/chip_ATAC/unique_and_bw.sh -b ${outputdir}/mapping/${Prefix}_rmdup.bam -o ${outputdir}/unique -p ${Prefix}_unique
