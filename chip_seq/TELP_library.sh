...
#cutadapt -a ${forward_adapt} -A ${reverse_adapt} -q 15,15 -m ${min_length} -o ${outputdir}/cutadapt/${Prefix}_1.fq -p ${outputdir}/cutadapt/${Prefix}_2.fq ${fastq1} ${fastq2}
#--read1
cutadapt -u -50 -o ${outputdir}/cutadapt/${Prefix}_trim3_1.fq ${fastq1}
cutadapt -u 50 -o ${outputdir}/cutadapt/${Prefix}_1.fq ${outputdir}/cutadapt/${Prefix}_trim3_1.fq
#--reads2
cutadapt -u -50 -o ${outputdir}/cutadapt/${Prefix}_trim3_2.fq ${fastq2}
cutadapt -u 50 -o ${outputdir}/cutadapt/${Prefix}_2.fq ${outputdir}/cutadapt/${Prefix}_trim3_2.fq
...
bamCoverage --bam ${outputdir}/mapping/${Prefix}_rmdup.bam -o ${outputdir}/bigwig/${prefix}_rpgc.bw --binSize 10 --normalizeUsing RPGC --effectiveGenomeSize 2652783500 --blackListFileName ${outputdir}/bigwig/${Prefix}_blacklist --extendReads 300 &
