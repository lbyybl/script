...
#--- stastic the interaction intre gene and different elements
	#--- split the different strand
		...
		#--- for pairs
		awk '{pos2=$3+150;pos4=$6+150;if ($4=="+" && $7=="+") printf "%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\n",$2,$3,pos2,$4,$5,$6,pos4,$7,$1}' ${Pairs_file} | sort -k 1,1 -k 2,2n -k 3,3n >> _${Prefix}pairspp.bed &
		PS1=$!
		awk '{pos2=$3+150;pos4=$6-150;if ($4=="+" && $7=="-") printf "%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\n",$2,$3,pos2,$4,$5,pos4,$6,$7,$1}' ${Pairs_file} | sort -k 1,1 -k 2,2n -k 3,3n >> _${Prefix}pairspn.bed &
		PS2=$!
		awk '{pos2=$3-150;pos4=$6-150;if ($4=="-" && $7=="-") printf "%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\n",$2,pos2,$3,$4,$5,pos4,$6,$7,$1}' ${Pairs_file} | sort -k 1,1 -k 2,2n -k 3,3n >> _${Prefix}pairsnn.bed &
		PS3=$!
		awk '{pos2=$3-150;pos4=$6+150;if ($4=="-" && $7=="+") printf "%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\n",$2,pos2,$3,$4,$5,$6,pos4,$7,$1}' ${Pairs_file} | sort -k 1,1 -k 2,2n -k 3,3n >> _${Prefix}pairsnp.bed &
		PS4=$!
		wait $PS1 $PS2 $PS3 $PS4
	#--- got the reads corresponding gene
		bedtools intersect -a _${Prefix}pairsnn.bed -b _${Prefix}Ngene.bed -sorted -wao | cut -f 1-9,14-15 | awk '{printf "%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\n",$5,$6,$7,$8,$1,$2,$3,$4,$9,$10,$11}' | sort -k 1,1 -k 2,2n -k 3,3n | bedtools intersect -a stdin -b _${Prefix}Ngene.bed -sorted -wao | cut -f 1-11,16-17 >> _${Prefix}nnnfinal.bed &
		PS5=$!
		bedtools intersect -a _${Prefix}pairspp.bed -b _${Prefix}Pgene.bed -sorted -wao | cut -f 1-9,14-15 | awk '{printf "%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\n",$5,$6,$7,$8,$1,$2,$3,$4,$9,$10,$11}' | sort -k 1,1 -k 2,2n -k 3,3n | bedtools intersect -a stdin -b _${Prefix}Pgene.bed -sorted -wao | cut -f 1-11,16-17 >> _${Prefix}pppfinal.bed &
		PS6=$!
		bedtools intersect -a _${Prefix}pairsnp.bed -b _${Prefix}Ngene.bed -sorted -wao | cut -f 1-9,14-15 | awk '{printf "%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\n",$5,$6,$7,$8,$1,$2,$3,$4,$9,$10,$11}' | sort -k 1,1 -k 2,2n -k 3,3n | bedtools intersect -a stdin -b _${Prefix}Pgene.bed -sorted -wao | cut -f 1-11,16-17 >> _${Prefix}npfinal.bed &
		PS7=$!
		bedtools intersect -a _${Prefix}pairspn.bed -b _${Prefix}Pgene.bed -sorted -wao | cut -f 1-9,14-15 | awk '{printf "%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\n",$5,$6,$7,$8,$1,$2,$3,$4,$9,$10,$11}' | sort -k 1,1 -k 2,2n -k 3,3n | bedtools intersect -a stdin -b _${Prefix}Ngene.bed -sorted -wao | cut -f 1-11,16-17 >> _${Prefix}pnfinal.bed &
		PS8=$!
	...
	ls _${Prefix}*final.bed.gz | parallel -k "awk '{if (\$11!=0 && \$13!=0) printf \"%s\\t%s\\t%s\\t%s\\n\",\$10,\$12,\$5,\$1}'"  '<(zcat {})'  | sort -k 1 -k 2 | uniq -c | awk '{printf "%s\t%s\t%s\t%s\t%s\n",$2,$3,$1,$4,$5}' | sort -k 3n >> $Output_file
