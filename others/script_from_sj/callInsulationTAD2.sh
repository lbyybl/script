...
for k in $(seq 1 19) X Y;
do
    python ../scripts/python/matrix2EigenVectors.py -i chr${k}_0h_25kb_matrix.addedHeaders.zScore.matrix.gz -r /DATA/software/hi-c/cworld-dekker/scripts/util/geneDensity/mm10.refseq.txt
done
