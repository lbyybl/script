...
cd ${outputdir}
bedtools intersect -a ${gene_bed} -b ${gro_seq_mapping_bed} -s -wao | awk '$7!=".",OFS="\t" {print $0}' >> ${outprefix}.bed
cut -f 1-6 ${outprefix}.bed | sort -k 1,1 -k 2n,2 -k 3n,3 | uniq -c | awk 'OFS="\t" {print $2,$3,$4,$5,$6,$7,$1}' >> ${outprefix}_num.bed
