...
# oceanc_dir <- '/DATA/work/lbyybl/ypjiang/geneloop/hichip_oceanc/pol2_ocean_c/allvalidpairs/Contact_strength/four_promoter'
setwd(hichip_dir)
...
savefile <- function(name){
  ggsave(paste0(name,".jpeg"), width = 5,height = 3)
  ggsave(paste0(name,".pdf"), width = 5,height = 3)
}
#--- draw heatmap
